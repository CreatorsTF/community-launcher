...
var Utilities = /** @class */ (function () {
    ...
    Utilities.GetCurrentVersion = function () {
        if (this.currentLauncherVersion == null) {
            try {
                var packageJson = fs_1.default.readFileSync(path_1.default.join(__dirname, "../package.json"));
    ...
    Utilities.currentLauncherVersion = null;
    return Utilities;
}());
